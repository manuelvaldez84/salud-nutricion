	  ...
	  <form action="consulta.html" method="post">
		...
		<th>Fibra</th>
		 ...
		 include ('conexion.php');
		  ...
		  $query=mysqli_query($con,"select mn.idmenu, mn.titulo_plato, mn.descripcion_plato, mn.carbohidratos, mn.grasas, mn.vitaminas, mn.minerales, mn.fibra from menus mn where tipo_menu=1") or
            ...
            echo "<h3>Se relacionan los datos de los desayunos registrados</h3><br><br>";
            ?>
      </body>
   </html>
